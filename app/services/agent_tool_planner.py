...
_PLANNER_INSTRUCTIONS = (
    ...
    "- Some tools are stages of a chain - their descriptions say so. Name every stage the "
    "learner asked for, in order, and leave the later stages' arguments empty ({}): each "
    "stage is given what the stage before it returned, which you cannot know yet.\n"
